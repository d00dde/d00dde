data = {
	host: 'https://d00dde.github.io/d00dde',
	colors: {
	...
	summary: {
		rus: {
			personal: {
				personImgSrc: 'https://d00dde.github.io/d00dde' + '/img/photo.jpeg',
				name: 'Андрей Лопатко',
		...
		download: {
			rus: {
				...
				path: 'https://d00dde.github.io/d00dde' + '/res/summary_rus.pdf'
			},
			eng: {
				msg: 'download as PDF',
				path:  'https://d00dde.github.io/d00dde' + '/res/summary_eng.pdf'
			}
		},
	}
}
