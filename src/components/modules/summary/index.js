  ...
  return (
      ...
      <div className="columns">
        <div className="left-col">
          <h3><i className={about.icon}></i>{about.title}</h3>
          <div className="info">{about.info}</div>
        </div>
        <div className="right-col">
        <div className="skills">
          <h3><i className={skills.icon}></i>{skills.title}</h3>
          <ul>
        ...
        <div className="education">
            <h3><i className={education.icon}></i>{education.title}</h3>
          <ul>
        ...
        <div className="experience">
          <h3><i className={experience.icon}></i>{experience.title}</h3>
          <ul>
        ...
        <div className="additional">
          <h3><i className={additional.icon}></i>{additional.title}</h3>
          <ul>
