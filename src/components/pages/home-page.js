...
export default (props) => {
	return (
		<div className='home-page'>
			...
			<Parallax image={<img src='https://d00dde.github.io/d00dde/img/parallax1.jpg' alt='first parallax'/>} />
			...
			<Features />
				<div className={`section ${props.bgColor}`}>
					<div className="row container">
						...
						<p className="grey-text text-darken-3 lighten-3">
							Ещё одним перспективным направлением является создвние приложений для мобильных устройств
			...
			<Parallax image={<img src='https://d00dde.github.io/d00dde/img/parallax2.jpg' alt='second parallax' />} />
				<div className={`section ${props.bgColor}`}>
					<div className="row container">
						<h3 className="header">
